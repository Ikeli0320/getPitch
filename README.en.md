...
**Language:** [繁體中文](README.md) · English (this page)
...
- **You already live on YouTube** — No second app or upload step; open the popup on the video in front of you.
- **Built for singers and teachers** — See how high the melody sits, get a **recommended key** tuned for comfortable range (peak ≤ D5) and common key signatures, with a **±3 semitone** transpose slider.
- **Honest feedback** — Key **confidence** and a warning when the guess is shaky; **silent-audio** handling so you are not misled by silence.
- **Private by default** — All analysis stays on your machine; **no network** calls for audio processing.
...
Search for the English listing (**getPitch - YouTube Key Detector**) when published, or install from the developer dashboard.
...
# Rebuild release ZIP (cross-platform, no dependencies)
npm run build:zip
```
...
See [CONTRIBUTING.en.md](CONTRIBUTING.en.md) (English) or [CONTRIBUTING.md](CONTRIBUTING.md) (繁體中文).
